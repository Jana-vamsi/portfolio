...
const buildLog = [
  ...
  { key: 'stack', value: 'React / React Native / MERN' },
  { key: 'focus', value: 'Responsive UI + real-world applications' },
];
      ...
      <div className="relative z-10 mx-auto grid min-h-[calc(100svh-7rem)] max-w-7xl items-center gap-10 px-4 pb-16 sm:px-6 lg:grid-cols-[1.02fr_0.98fr] lg:px-8">
        ...
        <div className="text-center lg:text-left">
          ...
          <p className="font-mono text-xs uppercase tracking-[0.32em] text-cyan-300 sm:text-sm">
            Vamsi Jana / Developer Portfolio
          </p>
          ...
          <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-slate-300 sm:text-lg lg:mx-0">
            I’m a final-year B.Tech student and frontend developer focused on
            building responsive web and mobile applications using React,
            React Native, Flutter, and the MERN stack.
          </p>
            ...
            <div className="p-5 sm:p-6">
              ...
              <div className="space-y-3 font-mono text-sm">
                ...
                {buildLog.map((item) => (
                  <div
                    key={item.key}
                    className="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-cyan-400/10 bg-slate-950/55 px-4 py-3"
                  >
              ...
              <div className="mt-5 rounded-xl border border-violet-400/20 bg-violet-400/10 p-4 text-left">
                ...
                <p className="font-mono text-xs uppercase tracking-[0.22em] text-violet-200">
                  build philosophy
                </p>

                <p className="mt-2 text-sm leading-6 text-slate-300">
                  I’m driven by self-motivation, continuous learning, and
                  creating intuitive applications that provide practical
